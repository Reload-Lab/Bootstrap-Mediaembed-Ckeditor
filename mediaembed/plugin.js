							...
							elements: [
								{
									id: 'embedArea',
									type: 'textarea',
									label: editor.lang.mediaembed.dialogArea,
									'autofocus': 'autofocus',
								...
								},
								{
									id: 'selectRatio',
									type: 'select',
									label: editor.lang.mediaembed.dialogRatio,
									items: [
										[editor.lang.mediaembed.selectRatio[0],'none'],
										[editor.lang.mediaembed.selectRatio[1],0],
										[editor.lang.mediaembed.selectRatio[2],1],
										[editor.lang.mediaembed.selectRatio[3],2],
										[editor.lang.mediaembed.selectRatio[4],3]
									],
									'default': 'none' 
								}
							]
